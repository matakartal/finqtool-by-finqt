...
import {
  usePrevious
} from "./chunk-YULN25GD.js";
import "./chunk-QP2QPFSM.js";
import {
  useDirection
} from "./chunk-O7BZT5HO.js";
import {
...
var Select = (props) => {
  ...
  return jsx(Root2, { ...popperScope, children: jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
var SelectPortal = (props) => {
  return jsx(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    return jsx(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: jsx(Combination_default, { as: Slot, allowPinchZoom: true, children: jsx(
          FocusScope,
          {
            asChild: true,
...
var SelectArrow = React.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? jsx(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
